import PopupWindow, { Padding } from "ts/widgets/popup_window"
import { AppItem, QuickButton } from "./app_item"
import icons from "ts/lib/icons"
import options from "ts/options"
import type Gtk from "gi://Gtk?version=3.0"
import { launchApp } from "ts/lib/utils"
import { Box, Revealer, Separator, Entry } from "resource:///com/github/Aylur/ags/widget.js"

const apps = await Service.import("applications")
const { query } = apps
const { width, margin, maxItem, favorites } = options.applauncher

const SeparatedAppItem = (app: Parameters<typeof AppItem>[0]) => Revealer(
    { attribute: { app } },
    Box<Gtk.Widget>(
        { vertical: true },
        Separator(),
